...
u_noise = 0;
sigma_noise = 0.3;   % 0.2/0.3!!!!!!!!


% External connectivity parameters
% A = [0.2   0.1
%      0.3   0.2];         % A = [0.2 0.1; 0.1 0.2]

A = SC;
C = gC;  % global scaling factor 5!!!
...
% epsi_E = u_noise + sigma_noise*randn(NR, 1);
% epsi_I = u_noise + sigma_noise*randn(NR, 1);
