...
%=======================================================================================
% Program to estimate effective connectivity (EC) in the Executive-Limbic network 
% This default m-script estimates EC for the control subject "NC001". 
...
% function FCobj. For example, for the subject NC010, we need to set
%           Subject = 'NC010';    
% 
