...
% Visualize the data in the DMN-SAL network
% Guoshi Li (5/24/2020)
...
NR = 7;     % Number of ROIs
NP = 37;    % Number of estimated parameters
NM = 2;     % Number of networks

Nb = [4 3]; % Number of ROIs in each network
...
VGC1 = VGC_NC_MD(1:N1/2, :);
VGC2 = VGC_NC_MD(N1/2+1:end, :);
...
VSE1 = VSE_NC_MD(1:N1/2, :);
VSE2 = VSE_NC_MD(N1/2+1:end, :);
...
ROI_LABEL = {'ACC', 'PCC', 'L.LPC', 'R.LPC'...
               'dACC', 'L.Insula', 'R.Insula'};
           
ROI_LABEL_NET = {'DMN', 'SAL'};             
           
           
INTER_LABEL = {'vACC-PCC', 'vACC-L.LPC', 'vACC-dACC', 'vACC-L.Insula', 'PCC-vACC',...
                 'PCC-dACC',  'PCC-R.Insula', 'L.LPC-vACC', 'L.LPC-dACC', 'L.LPC-L.Insula',...
                 'R.LPC-dACC', 'R.LPC-L.Insula', 'R.LPC-R.Insula', 'dACC-vACC', 'dACC-PCC',...
                 'dACC-L.LPC', 'dACC-R.LPC', 'L.Insula-vACC', 'L.Insula-L.LPC', 'L.Insula-R.LPC'...
                 'R.Insula-PCC', 'R.Insula-R.LPC'};    
             
      
FLIP_INTER_LABEL = flip(INTER_LABEL);
             

ROI_LABEL_NETWORK = {'D-D', 'E-D', 'S-D', 'L-D', 'D-E', 'E-E', 'S-E', 'L-E'...
              'D-S', 'E-S', 'S-S', 'L-S', 'D-L', 'E-L', 'S-L', 'L-L'};
